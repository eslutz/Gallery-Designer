...
import { getGroupBounds, translatePlacementGroup } from '../interaction/selection';
import { globalRectForPlacement } from './placement';
import { roundToPrecision } from '../../shared/format/units';
import { getInsetWallExteriorEdges, getSectionOffsetX, getSectionOffsetY } from '../wall/geometry';
