...
import App from './App';
import { LIBRARY_KEY, designKey, type DesignLibrary } from '../editor/designs/designLibrary';
import {
  LONG_PRESS_DELAY_MS,
...
vi.mock('../editor/export/exportDesign', async () => {
  const actual = await vi.importActual<typeof import('../editor/export/exportDesign')>(
    '../editor/export/exportDesign',
  );
