...
import { AdvancedDrawer } from '../editor/placement/AdvancedDrawer';
import { AppFooter } from './AppFooter';
import { BrandLogo } from './BrandLogo';
import { CollapsiblePanel } from '../shared/ui/CollapsiblePanel';
import { DesignSwitcher } from '../editor/designs/DesignSwitcher';
import { HookControls } from '../editor/placement/HookControls';
import { TooltipIconButton } from '../shared/ui/InfoTooltip';
import { ManageDesignsDialog } from '../editor/designs/ManageDesignsDialog';
import { MeasurementsTable } from '../editor/measurements/MeasurementsTable';
import { MessageToast } from './MessageToast';
import { NumberField } from '../shared/ui/NumberField';
import { PlacementSettingsDrawer } from '../editor/placement/PlacementSettingsDrawer';
import { RestoreLibraryDialog } from '../editor/designs/RestoreLibraryDialog';
import { ShortcutsDialog } from '../editor/interaction/ShortcutsDialog';
import { StagingTray } from '../editor/staging/StagingTray';
import { WallCanvas } from '../editor/wall/WallCanvas';
import {
  WallDragPreviewOverlay,
  type DragItemKind,
  type WallDragPreview,
} from '../editor/wall/WallDragPreviewOverlay';
import { WelcomeCard } from '../editor/onboarding/WelcomeCard';
import { useAlignmentGuides } from '../editor/interaction/alignmentGuides';
import { useStatusToast } from '../editor/state/useStatusToast';
import { useUndoHistory } from '../editor/state/useUndoHistory';
import { useWallZoomPan, type CursorInteraction } from '../editor/wall/useWallZoomPan';
import { autoPlacePieces } from '../editor/placement/autoPlace';
import {
  createDesign,
  deleteDesign,
  duplicateDesign,
  ...
  type DesignLibrary,
} from '../editor/designs/designLibrary';
import {
  parseDesignFile,
...
} from '../editor/designs/designFile';
import { downloadPdf, downloadPng, type ExportDesignInput } from '../editor/export/exportDesign';
import { formatCount } from '../shared/format/formatCount';
import {
  defaultState,
  ...
  withMessage,
  type GalleryState,
} from '../editor/state/galleryState';
import {
  distanceBetween,
  getPointerId,
  isTextEntryTarget,
  ...
  WALL_MOUSE_PAN_ID,
} from '../editor/interaction/pointerInput';
import { buildMeasurementInstructions } from '../editor/measurements/measurements';
import {
  getGroupBounds,
...
} from '../editor/interaction/selection';
import {
  getPlacementIssues,
...
import {
  ...
  type AlignmentGuide,
} from '../editor/placement/snapping';
import { formatMeasurement, roundToPrecision } from '../shared/format/units';
import {
...
} from '../editor/wall/geometry';
import { getDefaultWallZoomState, getWallCanvasBaseViewBox } from '../editor/wall/zoom';
import { getNextDuplicateName } from '../editor/designs/duplicateName';
import {
  findVerticalScrollContainer,
  getEdgeScrollDelta,
} from '../editor/interaction/edgeAutoScroll';
import {
  LONG_PRESS_DELAY_MS,
  pressMovedTooFar,
  requiresLongPress,
} from '../editor/interaction/longPressDrag';
import { hasSeenWelcome, setWelcomeSeen } from '../editor/onboarding/welcomeGuide';
import {
  isPlacedWallFeature,
  movePlacedFeaturesWithWallSection,
  resolveWallFeatureRule,
} from '../editor/wall/features';
import type {
  ArtPiece,
